...
class NotificationService {
     ...
     */
    async sendNotifications(webhooks, emails, payload) {
     ...
     */
    static createIncidentPayload(type, nestId, serviceId, serviceName, incident) {
        return {
            type,
            nestId,
            serviceId,
     ...
     */
    static createMaintenancePayload(type, nestId, serviceId, serviceName, maintenance) {
        return {
            type,
            nestId,
            serviceId,
